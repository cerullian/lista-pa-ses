const paises = async () => { // função que faz o fetch naquele endpoint, converte os dados e retorna a informação

    const response = await fetch('https://restcountries.com/v3.1/all'); // fica à espera de algo
